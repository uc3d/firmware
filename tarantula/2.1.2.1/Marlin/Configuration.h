...
#define STRING_CONFIG_H_AUTHOR "(uc3d)" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 41.50 } // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 21.18
  #define DEFAULT_bedKd 438.05
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 93, 93 } // 365~415
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, -35, 0 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 9, 26, 16, 27 } // (mm) Left, Front, Right, Back insets
