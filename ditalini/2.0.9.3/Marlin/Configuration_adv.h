...
//
  ...
  #define BED_CHECK_INTERVAL 250    // (ms) Interval between checks in bang-bang control
  #if ENABLED(BED_LIMIT_SWITCHING)
    #define BED_HYSTERESIS 0.25        // (°C) Only set the relevant heater state when ABS(T-target) > BED_HYSTERESIS
  #endif
#endif
...
#define G29_RETRY_AND_RECOVER
  ...
  #define G29_RECOVER_COMMANDS "M117 Probe failed. Calibrating.\nG28\nG34"
