...
#define STRING_CONFIG_H_AUTHOR "(uc3d, single nozzle high precision printer)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UC3D E386SX"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 131.23
  #define DEFAULT_bedKi  26.20
  #define DEFAULT_bedKd 438.16
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -10, -1.88 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN Z_MAX_PIN // Z-max endstop in mks sgenl v2
