...
#define STRING_CONFIG_H_AUTHOR "(UC3D, dual extruder 3D printer)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UC3D E386DX"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 164.10
  #define DEFAULT_bedKi 32.79
  #define DEFAULT_bedKd 547.55
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 63, 0, -2.1 }
